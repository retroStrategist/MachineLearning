...
amazon_model = RandomForestRegressor(random_state=5)

#Makes model fit values
amazon_model.fit(train_X, train_y)

#Predicition comparison
amaz_preds = amazon_model.predict(val_X)
print(mean_absolute_error(val_y, amaz_preds))
...
best_size = -1
for max_leaf_nodes in range(50, 2000, 50):
